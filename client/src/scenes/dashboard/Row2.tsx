...
const Row2 = ()=>{
    ...
    return(
        ...
        <FlexBetween mt="0.001rem" gap="1rem" pr="1rem">
        <PieChart 
      ...
      <Box ml="-0.7rem" flexBasis="40%" textAlign="center">
        ...
        <Typography m="0.3rem 0" variant="h3" color={palette.primary[300]}>83
        </Typography>
        <Typography variant="h6"> Finance goals ofthe campaign that is desired
      ...
      <Box flexBasis="50%">
        ...
        <Typography variant="h6">Losses are down 25%
        </Typography>
        <Typography variant="h6"> Finance goals ofthe campaign that is desired

        </Typography>
        <Typography mt="0.3rem" variant="h5">Profit Margins</Typography>
        <Typography mt="0.02rem" variant="h6">Margins are up by 30% from last month</Typography>
